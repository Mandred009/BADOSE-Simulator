// Script to handle buoyancy physics and calculations for the boat/ship
...
public class Buoyancy : MonoBehaviour{
    ...
    private void FixedUpdate(){
		...
		rb.AddForceAtPosition(Physics.gravity / floaters, transform.position, ForceMode.Acceleration); // Adds force at he floaters that is points of contact

		Search.startPosition = transform.position;

		water.FindWaterSurfaceHeight(Search, out SearchResult); // Finding the wave height for contact
